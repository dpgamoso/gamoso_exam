      ...
      <thead class="alert-info">
        ...
        <th>Account Status</th>
         ...
         <th>Action</th>
                     ...
                     <tr >
                      <?php
                      $query2 = $conn->query("select * from table_account order by account_number");
              ...
              <a  href="edituser.php?id=<?php echo $row['account_number']; ?>" class="btn btn-success"><span class="fas fa-fw fa-edit"></span> Edit</a>  
                 ...
                 <a  href="deleteuser.php?id=<?php echo $row['account_number']; ?>" class="btn btn-danger"><span class="fas fa-fw fa-x"></span> Delete</a>   
