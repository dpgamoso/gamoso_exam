                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="admin_update.php?id=<?php echo $id; ?>">
                                            <div class="row mb-3">
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text"  name="fn" value="<?php echo $fn; ?>" required />
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="mn"value="<?php echo $mn; ?>"  required/>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="ln" value="<?php echo $ln; ?>" required />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text"  name="birthdate" value="<?php echo $bday; ?>" required/>
