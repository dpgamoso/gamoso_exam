                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                              ...
                              <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="manageuser.php">Manage Users Account</a>
      ...
      <thead class="alert-info">
        ...
        <th>Account Status</th>
         ...
         <th>Action</th>
                     ...
                     <tr >
                      <?php
    $query = mysqli_query($conn, "SELECT * FROM `table_account` WHERE   `firstname` LIKE '%$keyword%' OR  `lastname` LIKE '%$keyword%' OR `middlename` LIKE '%$keyword%'   or `email` LIKE '%$keyword%'   or `address` LIKE '%$keyword%' or `department` LIKE '%$keyword%' or `account_status` LIKE '%$keyword%' or `user_level` LIKE '%$keyword%' ") or die(mysqli_error());
